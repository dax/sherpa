...
mod m20260215_000003_add_review_mode_and_agent_token;
mod m20260216_000001_add_block_agent_to_review_sessions;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260215_000003_add_review_mode_and_agent_token::Migration),
            Box::new(m20260216_000001_add_block_agent_to_review_sessions::Migration),
        ]
    }
}
